...
## Export the Plots
To export the plots generated by the scripts, you can use the following commands inside the activated virtual environment:
```sh
python export_plots.py
```
This will save all plots as PNG files with transparent background.